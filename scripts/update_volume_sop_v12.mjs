...
- 이 문서는 Single Source of Truth입니다.`;
    ...
    console.log('>>> Updating VOLUME_CONTROL_POLICY to v1.2...');

    // Deactivate old versions and upsert new one
    ...
    const { data, error } = await supabase
        ...
        }, { onConflict: 'sop_type, version' });

    if (error) {
        console.error('❌ Update failed:', error.message);
    } else {
        console.log('✅ SOP Successfully Updated to v1.2');
    }
}
