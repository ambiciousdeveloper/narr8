...
async function updateL1SOPs() {
    console.log('\n=== Updating L1 SOPs to v1.2 ===\n');
    ...
    if (origError) {
        console.error('❌ L1_ORIGINAL update error:', origError);
    } else {
        console.log('✅ L1_ORIGINAL updated to v1.2');
    }
    ...
    if (adaptError) {
        console.error('❌ L1_ADAPTED update error:', adaptError);
    } else {
        console.log('✅ L1_ADAPTED updated to v1.2');
    }
